...
public class ComercioEletronico
{
	public static void main(String[] args)
	{
		...
		// Pedido1
		// Pagamento utilizando modalidade de pagamento via cartão e modelo de fatura enviada por email
		...
		// Pedido2
		// Pagamento utilizando modalidade PIX e modelo de fatura enviada para impressora
